...
export function createDefaultData(): AppData {
  return {
    ...
    clocks: [
      ...
      clock({ id: 'wakeup', name: 'Wake Up', icon: '☀️', role: 'wakeup', time: '07:00', order: 1, colorId: 'gold' }),
      clock({ id: 'daddy', name: 'Wake Daddy', icon: '👨', role: 'person', time: '07:30', order: 2, colorId: 'blue', soundEnabled: true }),
      clock({ id: 'mummy', name: 'Wake Mummy', icon: '👩', role: 'person', time: '08:00', order: 3, colorId: 'pink', soundEnabled: true }),
      clock({ id: 'breakfast', name: 'Breakfast', icon: '🍳', role: 'event', time: '08:15', order: 4, colorId: 'orange' }),
